...
class Cantera:
    ...
    def plot(self, data, topSpecies=10, topSensitiveReactions=10):
        ...
        for i, conditionData in enumerate(data):
            ...
            PData = dataList[1]
            VData = dataList[2]
            speciesData = [data for data in dataList[3:] if data.species not in inertList]
            ...
            GenericPlot(xVar=time, yVar=VData).plot(os.path.join(self.outputDirectory,'{0}_volume.png'.format(i+1)))
    ...
    def simulate(self):
        ...
        for condition in self.conditions:
            ...
            while canteraSimulation.time<condition.reactionTime.value_si:
                ...
                volume.append(canteraReactor.volume)
            ...
            self.canteraReactor = canteraReactor
