...
class TestSimulator(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.simulator = afm.simulator_2mo.Simulator(chemkin_path, 
                                                dictionary_path,
    ...
    def test_fragment_chemistry(self):
        ...
        self.assertEqual(57, len(fragment_dict))
        self.assertEqual(176, len(fragment_reaction_list))
...
class TestOdeSimulator(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.odes = afm.simulator_2mo.OdeSimulator(chemkin_path,
                                              dictionary_path,
                                              fragment_smiles_path,
                                              temperature,
                                              pressure,
