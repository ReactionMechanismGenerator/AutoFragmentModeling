...
class TestUtils(unittest.TestCase):
	...
	def test_match_concentrations_with_different_sums1(self):
		...
		matches = afm.utils_1_sided.match_concentrations_with_different_sums(conc1, conc2)
	...
	def test_matches_resolve(self):
		...
		new_matches, new_r_l_moles = afm.utils_1_sided.matches_resolve(matches, rr_list)

		expected_new_matches = [(('RY', 'CCR'), 10),
							    (('ArCR', 'RCCCCR', 'ArCR'), 2),
				   			    (('C_CCR', 'RCC_CCR', 'C_CCR'), 3),
							    (('RY', 'TR'), 3)]
		expected_new_r_l_moles = [(('RCCCCR', 'RCC_CCR'), 3)]
